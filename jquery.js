...
function addItem(element) {
    ...
    // let nbrProduct = $("#quantity").val()
    // itemPrice *= nbrProduct
...
function doShowAll() {
    let key = ""
    let list = "<tr><th>Produit(s)</th><th>Prix</th></tr>\n"
    let items = 0
    ...
    if (list == "<tr><th>Produit(s)</th>\t<th>Prix</th></tr>\n") {
        list += "<tr><td><i></i></td><td><i></i></td></tr>\n"
    }
